defmodule Grizzly.ZWave.Commands.AntitheftSet do
  ...
  Params:
    ...
    * `:state` - This field MUST indicate the desired :locked or :unlocked state for the receiving node (required)

    * `:magic_code` - This field contains the 1 to 10 byte Magic Code used to lock or unlock the node (required)
