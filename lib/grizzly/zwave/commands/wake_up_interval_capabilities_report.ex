defmodule Grizzly.ZWave.Commands.WakeUpIntervalCapabilitiesReport do
  ...
  def encode_params(command) do
    ...
    if on_demand == nil do
      # v2
      <<
        minimum_seconds::3-unit(8),
        maximum_seconds::3-unit(8),
        default_seconds::3-unit(8),
        step_seconds::3-unit(8)
      >>
    else
      # v3
      <<
  ...
  # v3
  def decode_params(
        <<minimum_seconds::3-unit(8), maximum_seconds::3-unit(8), default_seconds::3-unit(8),
          step_seconds::3-unit(8), 0x00::size(7), on_demand_byte::size(1)>>
      ) do
    {:ok,
     [
       minimum_seconds: minimum_seconds,
