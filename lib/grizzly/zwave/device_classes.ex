defmodule Grizzly.ZWave.DeviceClasses do
  ...
  defmodule Generate do
    ...
    @specific_mappings [
      ...
      {:entry_control, 0x03, :secure_door_lock},
      {:entry_control, 0x04, :secure_keypad_door_lock},
      {:entry_control, 0x05, :secure_keypad_door_lock_deadbolt},
      {:entry_control, 0x06, :secure_door},
      {:entry_control, 0x07, :secure_gate},
      {:entry_control, 0x08, :secure_barrier_addon},
      {:entry_control, 0x09, :secure_barrier_open_only},
      {:entry_control, 0x0A, :secure_barrier_close_only},
      {:entry_control, 0x0B, :secure_lockbox},
