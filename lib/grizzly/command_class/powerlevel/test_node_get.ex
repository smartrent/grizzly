defmodule Grizzly.CommandClass.Powerlevel.TestNodeGet do
  @moduledoc """

  Command module for working with the Powerlevel command class TEST_NODE_GET command.
  It is used to get the results of a prior TEST_NODE_SET command.
   Command Options:
  ...
  def encode(%__MODULE__{seq_number: seq_number}) do
    binary = Packet.header(seq_number) <> <<0x73, 0x05>>
    {:ok, binary}
  end
