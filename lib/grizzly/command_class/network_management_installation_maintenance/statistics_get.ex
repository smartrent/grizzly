defmodule Grizzly.CommandClass.NetworkManagementInstallationMaintenance.StatisticsGet do
  ...
  @spec handle_response(t, Packet.t()) ::
          ...
          | {:done, NetworkManagementInstallationMaintenance.statistics_report()}
          | {:retry, t()}
          | {:queued, t()}
