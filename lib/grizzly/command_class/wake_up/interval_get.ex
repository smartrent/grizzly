defmodule Grizzly.CommandClass.WakeUp.IntervalGet do
  @moduledoc """
  Command module for working with Wake Up command class INTERVAL_GET command
  ...
  def encode(%__MODULE__{seq_number: seq_number}) do
    {:ok, Packet.header(seq_number) <> <<0x84, 0x05>>}
  end
