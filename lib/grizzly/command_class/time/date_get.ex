defmodule Grizzly.CommandClass.Time.DateGet do
  @moduledoc "Date get command for the time command class"
  ...
  def encode(%__MODULE__{seq_number: seq_number}) do
    binary = Packet.header(seq_number) <> <<0x8A, 0x03>>
    {:ok, binary}
  end
