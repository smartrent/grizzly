...
* Include raw notification event params when unable to parse ([#1130](https://github.com/smartrent/grizzly/pull/1130))

## [v8.15.0] - 2025-09-29

### Added

* Get the listening mode of a node from the ZIPGateway database ([#1125](https://github.com/smartrent/grizzly/pull/1125))
* Add `Grizzly.zipgateway_ready?/0` ([#1126](https://github.com/smartrent/grizzly/pull/1126))
...
* Implement User Credential v1 ([#1090](https://github.com/smartrent/grizzly/pull/1090))
