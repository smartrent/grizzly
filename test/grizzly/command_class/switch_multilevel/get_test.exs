defmodule Grizzly.CommandClass.SwitchMultilevel.Get.Test do
  use ExUnit.Case, async: true

  alias Grizzly.Packet
  alias Grizzly.CommandClass.SwitchMultilevel.Get
  ...
  describe "implements Grizzly.Command behaviour" do
    ...
    test "encodes correctly" do
      ...
      binary = <<35, 2, 128, 208, 8, 0, 0, 3, 2, 0, 0x26, 0x02>>
    ...
    test "handles switch binary report responses" do
      report = %{command_class: :switch_multilevel, command: :report, value: :off}
      {:ok, command} = Get.init([])
