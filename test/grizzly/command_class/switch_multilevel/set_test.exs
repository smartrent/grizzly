defmodule Grizzly.CommandClass.SwitchMultilevel.Set.Test do
  use ExUnit.Case, async: true

  alias Grizzly.Packet
  alias Grizzly.CommandClass.SwitchMultilevel.Set
  ...
  describe "implements the Grizzly command behaviour" do
    ...
    test "encodes correctly" do
      ...
      binary = <<35, 2, 128, 208, 6, 0, 0, 3, 2, 0, 0x26, 0x01, 0x00>>
    ...
    test "encodes incorrectly" do
      ...
      error =
        EncodeError.new(
          {:invalid_argument_value, :value, :blue, Grizzly.CommandClass.SwitchMultilevel.Set}
        )
