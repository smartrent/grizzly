defmodule Grizzly.CommandClass.Basic.GetTest do
  use ExUnit.Case, async: true

  alias Grizzly.Packet
  alias Grizzly.CommandClass.Basic.Get
  ...
  describe "implements Grizzly.Command behaviour" do
    ...
    test "encodes correctly" do
      ...
      binary = <<35, 2, 128, 208, 8, 0, 0, 3, 2, 0, 0x20, 0x02>>
    ...
    test "handles basic report responses" do
      report = %{command_class: :basic, command: :report, value: :off}
      {:ok, command} = Get.init([])
