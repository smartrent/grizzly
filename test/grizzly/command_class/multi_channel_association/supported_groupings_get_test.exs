defmodule Grizzly.CommandClass.MultiChannelAssociation.SupportedGroupingsGet.Test do
  use ExUnit.Case, async: true

  alias Grizzly.Packet
  alias Grizzly.CommandClass.MultiChannelAssociation.SupportedGroupingsGet
  ...
  describe "implements Grizzly.Command behaviour" do
    ...
    test "encodes correctly" do
      ...
      binary = <<35, 2, 128, 208, 8, 0, 0, 3, 2, 0, 0x8E, 0x05>>
