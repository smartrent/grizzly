defmodule Grizzly.ZWave.Commands.SwitchBinaryReportTest do
  ...
  describe "Support V1" do
    test "encodes correctly on" do
      {:ok, report} = Commands.create(:switch_binary_report, target_value: :on)
    ...
    test "encodes correctly unknown" do
      {:ok, report} = Commands.create(:switch_binary_report, target_value: :unknown)
    ...
    test "decodes correctly on" do
      ...
      expected_report = Commands.create(:switch_binary_report, target_value: :on)
    ...
    test "decodes correctly off" do
      ...
      expected_report = Commands.create(:switch_binary_report, target_value: :off)
    ...
    test "decodes correctly unknown" do
      ...
      expected_report = Commands.create(:switch_binary_report, target_value: :unknown)
  ...
  describe "Support V2" do
    test "encodes correctly on" do
      {:ok, report} =
        Commands.create(:switch_binary_report,
          target_value: :on,
          duration: 0,
          current_value: :off
        )
