defmodule Grizzly.ZWave.Commands.AdminCodeReportTest do
  ...
  test "creates the command and validates params" do
    assert {:ok, _command} = Commands.create(:admin_code_report, code: "1234")
  end

  describe "encodes params correctly" do
    test "setting user code available" do
      {:ok, command} = Commands.create(:admin_code_report, code: "0000")
    ...
    test "setting user code occupied" do
      {:ok, command} = Commands.create(:admin_code_report, code: "12345")
