defmodule Grizzly.ZWave.Commands.ConfigurationReportTest do
  ...
  describe "encodes params correctly" do
    test "when a 1 byte neg value is set" do
      ...
      assert <<0x0F, 0x01, 0x82>> == ConfigurationReport.encode_params(nil, configuration_set)
    end
    ...
    test "when a 1 byte pos value is set" do
      ...
      assert <<0x0F, 0x01, 0x73>> == ConfigurationReport.encode_params(nil, configuration_set)
    end
    ...
    test "when a 2 byte neg value is set" do
      ...
      assert <<0x0F, 0x02, 0xC8, 0x17>> == ConfigurationReport.encode_params(nil, command)
    end
    ...
    test "when a 2 byte pos value is set" do
      ...
      assert <<0x0F, 0x02, 0x73, 0x17>> == ConfigurationReport.encode_params(nil, command)
    end
    ...
    test "when a 3 byte neg value is set" do
      ...
      assert <<0x0F, 0x03, 0xC8, 0x17, 0x01>> == ConfigurationReport.encode_params(nil, command)
    end
    ...
    test "when a 3 byte pos value is set" do
      ...
      assert <<0x0F, 0x03, 0x73, 0x17, 0x01>> == ConfigurationReport.encode_params(nil, command)
    end
  end
  ...
  describe "decodes params correctly" do
    test "when 1 byte pos value" do
      ...
      assert {:ok, params} = ConfigurationReport.decode_params(nil, binary)
