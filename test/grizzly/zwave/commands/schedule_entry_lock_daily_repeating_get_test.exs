defmodule Grizzly.ZWave.Commands.ScheduleEntryLockDailyRepeatingGetTest do
  ...
  test "encodes params correctly" do
    ...
    assert expected_binary == ScheduleEntryLockDailyRepeatingGet.encode_params(nil, command)
  end

  test "decodes params correctly" do
    binary_params = <<20, 5>>
    {:ok, expected_params} = ScheduleEntryLockDailyRepeatingGet.decode_params(nil, binary_params)
