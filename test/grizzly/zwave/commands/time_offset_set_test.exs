defmodule Grizzly.ZWave.Commands.TimeOffsetSetTest do
  ...
  test "encodes params correctly" do
    ...
    expected_binary =
      <<0x01::size(1), 4::size(7), 0, 0x00::size(1), 60::size(7), 3, 23, 2, 10, 22, 2>>

    assert expected_binary == TimeOffsetSet.encode_params(command)
  end
  ...
  test "decodes params correctly" do
    ...
    {:ok, params} = TimeOffsetSet.decode_params(params_binary)
