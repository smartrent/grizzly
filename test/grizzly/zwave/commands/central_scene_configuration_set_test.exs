defmodule Grizzly.ZWave.Commands.CentralSceneConfigurationSetTest do
  ...
  test "encodes params correctly" do
    ...
    assert expected_params_binary == CentralSceneConfigurationSet.encode_params(nil, command)
  end

  test "decodes params correctly" do
    params_binary = <<0x01::1, 0x00::7>>
    {:ok, params} = CentralSceneConfigurationSet.decode_params(nil, params_binary)
