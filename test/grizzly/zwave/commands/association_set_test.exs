defmodule Grizzly.ZWave.Commands.AssociationSetTest do
  ...
  test "creates the command and validates params" do
    ...
    {:ok, _command} = Commands.create(:association_set, params)
  end
  ...
  test "encodes params correctly" do
    ...
    assert expected_binary == AssociationSet.encode_params(nil, command)
  end

  test "decodes params correctly" do
    binary_params = <<0x02, 0x04, 0x05, 0x06>>
    {:ok, params} = AssociationSet.decode_params(nil, binary_params)
