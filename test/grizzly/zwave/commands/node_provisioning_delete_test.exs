defmodule Grizzly.ZWave.Commands.NodeProvisioningDeleteTest do
  ...
  test "creates the command and validates params" do
    ...
    {:ok, _command} = Commands.create(:node_provisioning_delete, params)
  end

  test "encodes params correctly" do
    params = [seq_number: 0x01, dsk: Utils.mkdsk()]
    {:ok, command} = Commands.create(:node_provisioning_delete, params)

    expected_binary =
      <<0x01, 0x10, 196, 109, 73, 131, 38, 196, 119, 227, 62, 101, 131, 175, 15, 165, 14, 39>>

    assert expected_binary == NodeProvisioningDelete.encode_params(nil, command)
  end
  ...
  test "decodes params correctly" do
    ...
    {:ok, params} = NodeProvisioningDelete.decode_params(nil, binary_params)
