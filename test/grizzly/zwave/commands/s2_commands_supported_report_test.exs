defmodule Grizzly.ZWave.Commands.S2CommandsSupportedReportTest do
  ...
  test "encodes params correctly" do
    ...
    bin = S2CommandsSupportedReport.encode_params(nil, cmd)
  ...
  test "decodes params correctly" do
    {:ok, params} = S2CommandsSupportedReport.decode_params(nil, <<0x63, 0x85>>)
    assert [:user_code, :association] = params[:command_classes]

    {:ok, params} = S2CommandsSupportedReport.decode_params(nil, <<0x63>>)
