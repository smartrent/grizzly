defmodule Grizzly.ZWave.Commands.S2ResynchronizationEventTest do
  ...
  test "encodes params correctly" do
    ...
    assert expected_binary == S2ResynchronizationEvent.encode_params(nil, command)
  ...
  test "decodes  params correctly" do
    binary_params = <<5, 0>>
    {:ok, params} = S2ResynchronizationEvent.decode_params(nil, binary_params)
  ...
  test "parse version 3 - 8 bit node id" do
    ...
    {:ok, params} = S2ResynchronizationEvent.decode_params(nil, binary)
