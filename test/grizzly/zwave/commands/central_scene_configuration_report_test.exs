defmodule Grizzly.ZWave.Commands.CentralSceneConfigurationReportTest do
  ...
  test "encodes params correctly" do
    ...
    assert expected_params_binary == CentralSceneConfigurationReport.encode_params(nil, command)
  end

  test "decodes params correctly" do
    params_binary = <<0x01::1, 0x00::7>>
    {:ok, params} = CentralSceneConfigurationReport.decode_params(nil, params_binary)
