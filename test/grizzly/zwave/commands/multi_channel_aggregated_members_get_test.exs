defmodule Grizzly.ZWave.Commands.MultiChannelAggregatedMembersGetTest do
  ...
  test "encodes params correctly" do
    ...
    assert expected_binary == MultiChannelAggregatedMembersGet.encode_params(nil, command)
  end

  test "decodes params correctly" do
    params_binary = <<0x00::1, 0x01::7>>
    {:ok, params} = MultiChannelAggregatedMembersGet.decode_params(nil, params_binary)
