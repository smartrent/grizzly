defmodule Grizzly.ZWave.Commands.AssociationGroupInfoReportTest do
  ...
  test "creates the command and validates params" do
    ...
    {:ok, _command} = AssociationGroupInfoReport.new(params)
  end
  ...
  test "encodes params correctly" do
    ...
    {:ok, command} = AssociationGroupInfoReport.new(params)

    expected_binary =
      <<0x01::size(1), 0x00::size(1), 0x02::size(6), 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x02, 0x00, 0x20, 0x01, 0x00, 0x00, 0x00>>
